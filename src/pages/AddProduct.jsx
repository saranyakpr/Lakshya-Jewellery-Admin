...
function AddProduct() {
  return (
    <PageLayout
      eyebrow='Add New Product'
      title='Fill in all fields to list a new jewellery product'
      description='Create a product listing with pricing, inventory, and product details.'
      actions={
        <>
          <button className='inline-flex items-center gap-2 rounded-xl border border-[#d4c3d8] bg-white px-4 py-2 text-sm font-semibold text-[#5f4b6e] shadow-sm transition hover:border-[#cbb5d2] hover:bg-[#faf4ff]'>
            <FiSave className='h-4 w-4' />
            Save as Draft
          </button>
          <button className='inline-flex items-center gap-2 rounded-xl bg-[#7c21a0] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_16px_30px_rgba(124,33,160,0.24)] transition hover:bg-[#8c33b5]'>
    ...
    >
      <div className='grid gap-6 xl:grid-cols-[1.6fr_1fr]'>
        <div className='space-y-6'>
          <section className='rounded-[1.8rem] border border-[#efe3ed] bg-white p-6 shadow-[0_8px_30px_rgba(77,37,74,0.06)]'>
            ...
            <div className='grid gap-4 sm:grid-cols-2'>
              <label className='space-y-2 text-sm font-medium text-[#5a4b63]'>
                ...
                <input
                  ...
                  className='w-full rounded-2xl border border-[#e8dfe8] bg-[#fbf4ff] px-4 py-3 text-sm text-[#312533] outline-none transition focus:border-[#b78cd2] focus:ring-2 focus:ring-[#e9d4ff]'
                />
              </label>
              <label className='space-y-2 text-sm font-medium text-[#5a4b63]'>
                SKU / Product Code *
          ...
          <section className='rounded-[1.8rem] border border-[#efe3ed] bg-white p-6 shadow-[0_8px_30px_rgba(77,37,74,0.06)]'>
            ...
            <div className='grid gap-4 sm:grid-cols-2'>
              <label className='space-y-2 text-sm font-medium text-[#5a4b63]'>
                Category *
                <select className='w-full rounded-2xl border border-[#e8dfe8] bg-[#fbf4ff] px-4 py-3 text-sm text-[#312533] outline-none transition focus:border-[#b78cd2] focus:ring-2 focus:ring-[#e9d4ff]'>
        ...
        <div className='space-y-6'>
          <div className='rounded-[1.8rem] border border-[#efe3ed] bg-white p-6 shadow-[0_8px_30px_rgba(77,37,74,0.06)]'>
