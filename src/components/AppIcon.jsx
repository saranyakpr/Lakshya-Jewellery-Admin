const iconPaths = {
  ...
  notification: (
    <>
      <path d='M12 5.25a4.35 4.35 0 0 0-4.35 4.35v2.14c0 .6-.2 1.18-.58 1.65L5.9 14.86A.75.75 0 0 0 6.48 16h11.04a.75.75 0 0 0 .58-1.14l-1.17-1.47a2.63 2.63 0 0 1-.58-1.65V9.6A4.35 4.35 0 0 0 12 5.25Z' />
      <path d='M9.85 17.25a2.45 2.45 0 0 0 4.3 0' />
      <circle cx='18.25' cy='6.25' r='1.75' fill='currentColor' stroke='none' />
    </>
  ),
  profile: (
    <>
      <circle cx='12' cy='8.5' r='3' />
      <path d='M6.5 18c1.2-2.6 3.15-3.9 5.5-3.9s4.3 1.3 5.5 3.9' />
    </>
  ),
  logout: (
    <>
      <path d='M10 5.25H8.75A2.75 2.75 0 0 0 6 8v8a2.75 2.75 0 0 0 2.75 2.75H10' />
      <path d='M13.5 8.5 18 12l-4.5 3.5' />
      <path d='M10 12h8' />
    </>
  ),
  plus: (
